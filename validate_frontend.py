    ...
    for i, line in enumerate(lines, 1):
        for match in re.finditer(func_pattern, line):
            ...
            if func_name in func_defs:
                errors.append(
                    f"Line {i}: Duplicate function '{func_name}' (first at line {func_defs[func_name]})"
                )
            else:
...
if __name__ == "__main__":
    # Support both local and CI paths
    possible_paths = [
        "static/index.html",
        "/home/sinope/Documents/opencodeprojects/family-finance/static/index.html",
    ]
